...
Test(ShapeCircle, base_values)
{
	...
	std::shared_ptr<arc::ShapeCircle> c = std::make_shared<arc::ShapeCircle>(nullptr, t, r);
	std::shared_ptr<arc::ShapeCircle> c1 = std::make_shared<arc::ShapeCircle>(*c);
	std::shared_ptr<arc::ShapeCircle> c2 = std::make_shared<arc::ShapeCircle>(nullptr, t, r.pos(), 2);
...
Test(ShapeCircle, children)
{
	arc::Texture t(arc::Color::White, arc::Color::Black);
	arc::RectF r(0, 0, 1, 1);
	std::shared_ptr<arc::ShapeCircle> c = std::make_shared<arc::ShapeCircle>(nullptr, t, r);
	std::shared_ptr<arc::ShapeCircle> c1 = std::make_shared<arc::ShapeCircle>(c, t, r);
