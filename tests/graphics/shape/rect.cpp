...
Test(ShapeRect, base_values)
{
	arc::Texture t(arc::Color::White, arc::Color::Black);
	arc::Texture t1(arc::Color::Black, arc::Color::White);
	arc::RectF r(0, 0, 1, 1);
	arc::RectF r1(0, 1, 1, 1);
	std::shared_ptr<arc::ShapeRect> c = std::make_shared<arc::ShapeRect>(nullptr, t, r);
	std::shared_ptr<arc::ShapeRect> c1 = std::make_shared<arc::ShapeRect>(*c);
...
Test(ShapeRect, children)
{
	arc::Texture t(arc::Color::White, arc::Color::Black);
	arc::RectF r(0, 0, 1, 1);
	std::shared_ptr<arc::ShapeRect> c = std::make_shared<arc::ShapeRect>(nullptr, t, r);
	std::shared_ptr<arc::ShapeRect> c1 = std::make_shared<arc::ShapeRect>(c, t, r);
